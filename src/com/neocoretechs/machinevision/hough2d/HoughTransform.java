...
public class HoughTransform { 
    ...
    final int maxTheta = 256;  // was 180
    ...
    public int getColumns() { return doubleHeight; }
    ...
    public void addPoints(BufferedImage image) { 
        ...
        for (int x = 0; x < image.getWidth(); x++) { 
            for (int y = 0; y < image.getHeight(); y++) { 
                ...
                //data[i] = data[i] > 0 ? -1 : 0xff000000; canny edge
            } 
        } 
    } 
    ...
    public BufferedImage getHoughArrayImage() { 
        ...
        for (int t = 0; t < maxTheta; t++) { 
            for (int r = 0; r < doubleHeight; r++) { 
                ...
                image.setRGB(t, r, c);
                //System.out.println("t="+t+" r="+r+" hough:"+houghArray[t][r]);
            	//}
            } 
        } 
        return image; 
